    ...
    <footer className='max-container'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
            ...
            <div key={section}>
              ...
              <ul className=''>
                {section.links.map((link)=>(
                  <li className='mt-3 text-white-400 font-montserrat text-base hover:text-slate-gray cursor-pointer' key={link.name}>
                    <a>{link.name}</a>
                  </li>
                ))}
              </ul>
        ...
        <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
          ...
          <p className='font-montserrat cursor-pointer'>Copyright. All rights reserved.</p>
        </div>
