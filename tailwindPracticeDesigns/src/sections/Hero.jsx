    ...
    >
      ...
      >
        ...
        <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-bold'>
          <span className='xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 mb-3'>The New Arrival</span>
          <br/>
          <span className='text-coral-red inine-block mt-3'>Nike</span> Shoes
        </h1>
      ...
      <div className='relative flex-1 flex justify-center xl:min-h-screen max-xl:py-40 bg-primary'>
        <img
          src={bigShoe1}
          alt="shoes"
          width={610}
